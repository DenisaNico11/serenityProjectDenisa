...
/**
 * Created by loredanamoga on 7/24/2017.
 */
public class EmagTest {
    ...
    public void openChromeTest() {
        System.setProperty("webdriver.chrome.driver", "E://src//src//Drivers//chromedriver.exe");
    ...
    public void searchTest(){
        ...
        //pageNo = driver.findElement(By.cssSelector("emg-pagination-no:last-child")).getText();
        ...
        dynamicElement = (new WebDriverWait(driver, 10)).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".lazy")));
        ...
        dynamicElement3 = (new WebDriverWait(driver, 10)).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".btn.btn-primary.btn-emag.btn-block.yeahIWantThisProduct.gtm_680klw")));
        addToCart = driver.findElement(By.cssSelector(".btn.btn-primary.btn-emag.btn-block.yeahIWantThisProduct.gtm_680klw"));
        addToCart.click();

        dynamicElement2 = (new WebDriverWait(driver, 10)).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".btn")));
